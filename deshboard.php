...
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','beverage_table')"
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td><button href="javascript:void(0)"
                                onclick="document.getElementById('userprofile').style.display='block'; change('<?php echo $row['Id']; ?>','<?php echo $row['Name']; ?>','<?php echo $row['City'] ?>','<?php echo $row['Tax']; ?>','City')"
                                class="w3-blue w3-button ">Edit</i></button></td>
                        <td>
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','city')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','bridal_dress')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','photographer')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','stage_decoraction')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['Price'] ?></td>
                        <!-- Edit Button  -->
                        <!-- Which call changed function and pass Id, Car Name Price and Table Name  -->
                        <td><button href="javascript:void(0)"
                        ...
                        <td>
                            <!-- Delete Button  -->
                            <!-- Which call deleteRecord function and pass Id and Table Name  -->
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','rental_car')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['Type'] ?></td>
                        <!-- Edit Button  -->
                        <!-- Which call changed function and pass Id, Dish Name, Type, Price and Table Name  -->
                        <td><button href="javascript:void(0)"
                        ...
                        <td>
                            ...
                            <!-- Which call deleteRecord function and pass Id and Table Name  -->
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','rice_table')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <button href=" javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','salad_table')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <button href=" javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','curry_table')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
            ...
            <div class="w3-padding">
                ...
                <table class="w3-table w3-table-all w3-hoverable w3-margin-top w3-centered w3-striped ">
                    ...
                    <tr>
                        ...
                        <td>
                            <button href="javascript:void(0)"
                                onclick="document.getElementById('delete_record').style.display='block'; deleteRecord('<?php echo $row['Id'] ?>','sweet')"
                                class="w3-red w3-button ">Delete</button>
                        </td>
                    </tr>
                    <?php
    ...
    function change(id, Name, City, Tax, Table) {
    ...
    function newrecord(table) {
        ...
        if (table === 'City') {
            ...
            price.setAttribute('placeholder', 'Tax Rate')
            price.removeAttribute('hidden')

            let marquee_lable = document.getElementById('new_marquee_lable')
            marquee_lable.innerText = 'Marquee Name'
            marquee_lable.removeAttribute('hidden')

            let marquee = document.getElementById('new_marquee')
            marquee.setAttribute('placeholder', 'Marquee Name')
